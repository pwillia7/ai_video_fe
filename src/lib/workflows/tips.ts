...
const PATCHES: Record<string, TipSection> = {
  ...
  style: {
    ...
    items: [
      ...
      "Only the three workflows on the `fl2va` model offer this: text to video, image to video and Extend. Reference to Video and Remix run a different checkpoint that these LoRAs were not made for.",
